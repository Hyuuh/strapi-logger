...
export interface ApiAuditTrailAuditTrail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    log: Schema.Attribute.Relation<'oneToOne', 'api::log.log'>;
...
export interface ApiLogLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    app: Schema.Attribute.String & Schema.Attribute.Required;
    audit_trail: Schema.Attribute.Relation<
      'oneToOne',
      'api::audit-trail.audit-trail'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    userRole: Schema.Attribute.String & Schema.Attribute.Required;
  };
}
